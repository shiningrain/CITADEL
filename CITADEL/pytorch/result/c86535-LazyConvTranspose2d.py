...
class MyModule(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = func_cls(out_channels=1, kernel_size=(1,256), stride=511, padding=255, dilation=(1, 2))
        self.conv2 = func_cls(out_channels=1, kernel_size=(1,1), stride=2, dilation=(1014, 2), padding=0)
