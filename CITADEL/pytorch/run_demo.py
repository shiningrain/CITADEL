...
if __name__=='__main__':
    ...
    parser.add_argument('--case_csv','-cc',default='./demo/demo.csv', help='case_csv')
    parser.add_argument('--save_dir','-sd',default='./demo', help='save dir')
    parser.add_argument('--log_path','-lp',default='./demo/log', help='log file')
    parser.add_argument('--fail_path','-fp',default='./demo/fail', help='record failure')
    parser.add_argument('--not_reproduce','-nr',default='./demo/not_reproduce', help='record the issue that cant reproduce')
    ...
    for case in case_list:
        ...
        outputs=execute_codes(new_save_path,candidate_func_list,similar_func_list,version,problem_type,input_process=True)
        # enable the input_process to solve the dimension mismatch problem
        if outputs==[]:
