...
def build_model(ch: int, groups: int = 1) -> nn.Module:
    return nn.Sequential(
        func_cls(3, ch, (1, 1, 1)),
        func_cls(ch, ch, (3, 3, 3), padding=1, groups=groups),  # 0
        func_cls(ch, ch, (3, 3, 3), padding=1, groups=groups),  # 1
        func_cls(ch, ch, (3, 3, 3), padding=1, groups=groups),  # 2
        func_cls(ch, ch, (3, 3, 3), padding=1, groups=groups),  # 3
        func_cls(ch, ch, (3, 3, 3), padding=1, groups=groups),  # 4
        func_cls(ch, ch, (3, 3, 3), padding=1, groups=groups),  # 5
        func_cls(ch, ch, (3, 3, 3), padding=1, groups=groups),  # 6
        func_cls(ch, ch, (3, 3, 3), padding=1, groups=groups),  # 7
